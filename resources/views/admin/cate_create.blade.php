...
<div class="container-fluid">
    <form class="form-horizontal" method="post" action="/admin/cate">
        {{ csrf_field() }}
        <div class="form-group">
            <label for="input-name" class="col-sm-1">分类名称</label>
            <div class="col-md-5">
                <input type="text" class="form-control" name="cate[name]" id="input-name" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <input type="text" class="form-control" name="cate[order_num]" id="input-order_num" />
            </div>
        </div>
